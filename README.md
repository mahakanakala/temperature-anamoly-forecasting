...
- ![Alt text](image.png)
- `sns.jointplot()`: distrubtion and linear regression: use it to find if the seasons of the year has an affect on the percentage of temperature change (would need to make a ne column of season labeling summer, fall, spring, winter)
